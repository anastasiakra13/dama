$(function(){
	...
	$('.popular').each(function(){
		var $tabsBlock = $('.popular_all_tabs_block ul', this);
		var $tabsBtn = $('.popular_tab_btns a', this);

		$tabsBtn.click(function(){
		$tabsBlock.eq($(this).index()).addClass('active').siblings().removeClass('active');
		$(this).addClass('active').siblings().removeClass('active');
		return false;
		}).eq(0).click();
	});
